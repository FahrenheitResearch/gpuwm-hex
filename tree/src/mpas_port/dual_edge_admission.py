...
(``src/mpas_port/cuda_horizontal_v841.py:215-217``)::
...
Measured on the registered generated mesh ``v15.150.38857`` (the proving node, RTX
...
def admit_dual_edges(
    ...
    *,
    ...
    raise DualEdgeAdmissionError(
        ...
        "(src/mpas_port/cuda_horizontal_v841.py:215-217) -- so a tangential gradient "
