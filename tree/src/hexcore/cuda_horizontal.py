...
compiled through :mod:`hexcore.cuda_backend`; inputs and outputs remain
...
class CudaHorizontal:
    ...
    def _kernel(self, name: str) -> Any:
        ...
        if kernel is None:
            kernel = self.kernel_cache.raw_kernel(
                name,
                _CUDA_SOURCE,
                module_key="hexcore.cuda_horizontal",
            )
    ...
    def compute_dry_mixing_tendencies(
        ...
        *,
        ...
        ``config`` is the existing :class:`hexcore.mixing.MixingConfig`
